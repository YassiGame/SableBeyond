...
**Each feature is highly configurable**. For example, if you do not want entity mass, no problem you can disable it in the config. You just need to locate the 
`config/sable_beyond` folder, where all the config files are stored.
